          ...
          return (
            ...
            >
              ...
              >
                ...
                {/* Glow effect on hover */}
                <div
                  className={`absolute inset-0 bg-gradient-to-tr from-indigo-500/20 to-purple-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${hoveredProject === project.id ? "animate-pulse" : ""}`}
                />
              ...
              <div className="w-full md:w-1/2 space-y-4">
                ...
                <div className="flex flex-wrap gap-2 mb-8">
                  {project.tech.map((t, i) => (
                    <span
                      key={i}
                      className="text-xs px-3 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm transition-all duration-300 hover:bg-white/10 hover:border-indigo-500/50 hover:scale-105 hover:shadow-lg hover:shadow-indigo-500/20 cursor-default tech-chip"
                      style={{
                        transitionDelay: `${i * 30}ms`,
                        animationDelay: `${i * 100}ms`,
                      }}
